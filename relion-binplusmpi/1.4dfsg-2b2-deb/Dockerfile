...
LABEL    software="relion-bin-plusmpi" \ 
    ...
    version="1" \ 
    about.license_file="/usr/share/doc/relion-bin+mpi/copyright" \ 
...
RUN apt-get update && apt-get install -y relion-bin+mpi && apt-get clean && apt-get purge && rm -rf /var/lib/apt/lists/* /tmp/*
USER biodocker
